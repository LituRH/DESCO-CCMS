...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="1" class="graybox" style="background-color:#dddd;">
  ...
  <center><table width="677px;" border="0" cellpadding="0" cellspacing="0" class="text">                      
	<tr id="entryTableHeader1" style="height:30px; ">
      <td   style="font-size:17px;text-align:center;BACKGROUND-COLOR:#9966CC;">Closed Complains </td>
  ...
  <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
      ...
      <td width="100" style="font-size:17px; height:30px;background-color:#a3c2c2;color:black;";>Status</td>
	   <td width="150" style="font-size:17px; height:30px;background-color:#a3c2c2;color:black;">Details</td>
		...
		while($row = mysql_fetch_array($tt))
        {
		 ...
		 ?>
		 	  <?php 
		$result ="SELECT * FROM tbl_complain where eng_id='$e_id' AND comp_status='Closed'  order by comp_id desc";
		$tt=mysql_query($result);
      ...
      <td width="500" style="font-size:16px; height:30px;background-color:#FFFFFF;color:black;"><?php echo $date."*";?></td><?php } ?>
	  <?php if(($dateclose)>=($datetoday)) {?>
	     <td width="500" style="font-size:16px; height:30px;background-color:#FFFFFF;color:black;"><?php echo $date;?></td><?php } ?>
      <td width="500" style="font-size:16px; height:30px;background-color:#FFFFFF;color:black;"><?php echo $status;?></td>
	   <td width="500" style="font-size:16px; height:30px;background-color:#FFFFFF;color:black;"><?php  echo "<a href='engrCompDetails2.php?compid=$row[0]'>Click Here</a>";?></td>
