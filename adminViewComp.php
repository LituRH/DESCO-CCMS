...
<tr>
	...
	</table>		<center><table width="677px;" border="0" cellpadding="0" cellspacing="0" class="text">                      
	<tr id="entryTableHeader1" style="height:30px; ">
      <td   style="font-size:17px;text-align:center;BACKGROUND-COLOR:#9966CC;"> Comaplain List </td>
    ...
    <tr align="center" id="listTableHeader"  style="color:white;";>
	  ...
	  <td width="100" style="font-size:17px; height:30px;background-color:#a3c2c2;color:black;";>Branch</td>
	   <td width="100" style="font-size:17px; height:30px;background-color:#a3c2c2;color:black;">Details</td>
		  ...
		  <?php 
		if ($brname=="")
			$result ="SELECT * FROM tbl_complain ORDER BY comp_id DESC";
		else if ($brname!="")
			$result ="SELECT * FROM tbl_complain WHERE comp_zone='$brname' ORDER BY comp_id DESC";
	 ...
	 <tr align="center" class="row2"  style="color:black;";>
      ...
      <td width="500" style="font-size:16px; height:30px;background-color:#ffffff; color:black;"><?php if($status=="Open"){echo "Pending";}else{echo $status;} ?></td>
	   <td width="500" style="font-size:16px; height:30px;background-color:#ffffff; color:black;"><?php echo $bnamed;?></td>
	     <td width="500" style="font-size:16px; height:30px;background-color:#ffffff; color:black;"><?php   if($status=="Closed") { echo "<a href='report.php?compid=$row[0]'>Click Here</a>"; } else {echo "<a href='adminCompDetails.php?compid=$row[0]'>Click Here</a>";}?></td>
    </tr>
