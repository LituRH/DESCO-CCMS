...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="1" class="graybox" style="background-color:#dddd;">
  ...
  <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
    ...
    <tr align="center" id="listTableHeader"  style="color:white;";>
      <td width="100" style="font-size:16px; height:30px;background-color:#a3c2c2;color:black;font-weight:bold;">SL No</td>
      <td width="200" style="font-size:16px; height:30px;background-color:#a3c2c2;color:black;font-weight:bold;">Branch Code </td>
      <td width="350" style="font-size:16px; height:30px;background-color:#a3c2c2;color:black;font-weight:bold;">Branch Name</td>
      <td width="700" style="font-size:16px; height:30px;background-color:#a3c2c2;color:black;font-weight:bold;">Address</td>
    </tr>
...
$result ="SELECT * FROM tbl_branch";
		...
		while($row = mysql_fetch_array($tt))
        {
			...
			$userid=$row['branch_username'];
			$pass=$row['branch_password'];
			$address=$row['address'];
			$cmanagar=$row['comp_managar'];
