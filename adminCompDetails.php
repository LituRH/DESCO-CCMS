...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="1" class="graybox" style="background-color:#dddd;">
  ...
  <form action="" method="post"  name="frmListUser" >
  <div id="yes">
  <table width="667" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#336699" class="entryTable">
  <tr style="height:30px; ">
  <td colspan="2" style="font-size:17px; BACKGROUND-COLOR:#9966CC;color:white;"><center>Complain Details </center></td>
  </tr>
     ...
     <tr class="entryTable">
             ...
             <td  style="font-size:15px; height:30px;width:500px;text-align:left;background-color:#a3c2c2;color:blacke;";>&nbsp;&nbsp;<?php echo $compid;?></td>
            </tr>
			<tr class="entryTable">
		...
		<tr class="entryTable">
			...
			<?php }?>
			     ...
			     <tr style="BACKGROUND-COLOR:#F0FFFF;color:white;height:30px;"> 
            <td colspan="2" width="100%" style="BACKGROUND-COLOR:#F0FFFF;color:white;">
			<center><input type="button" style="BACKGROUND-COLOR:#9966CC;color:white;font-size:16px;" value="Print" onclick="printPage('yes');"></input></center>
			</td>
           </tr>
        </table></td>
    </tr>
